...
namespace HeadRotation.Render
{
    public class ShaderController
    {
        ...
        public ShaderController(String vsFileName, String fsFileName)
        {
            ...
            var fullVS = Path.Combine(dir, "bin", vsFileName);
            var fullFS = Path.Combine(dir, "bin", fsFileName);
        ...
        public bool UpdateUniform(String name, Matrix4[] matArray)
        {
        ...
        public bool UpdateUniform(String name, Vector3 vec)
        {
        ...
        public bool UpdateUniform(String name, Vector4 vec)
        {
        ...
        public bool UpdateUniform(String name, Matrix4 mat)
        {
